...
try:
    ALDEA_RPS = float(os.getenv("ALDEA_RPS", "0.5")) # looks like it's actually 0.5 RPS?
except Exception:
    ALDEA_RPS = 0.5
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name",
        required=True,
        help="Prefix model name with 'assembly/', 'openai/', 'elevenlabs/', 'revai/', 'speechmatics-batch/', 'speechmatics-rt/', 'deepgram/', or 'groq/'",
    )
